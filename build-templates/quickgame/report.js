...
! function () {
	...
	wx.getUserInfo = wx.getSetting = function(obj) {
		setTimeout(function(){
			obj.fail && obj.fail()
		}, 1)
	}
    ...
    function f(e, n) {
        ...
        function r1() {
            return new Promise(function (t, n) {
                ...
                xhr.open('POST', 'https://report.mcbeam.pro/app_log', true);
                xhr.onabort = xhr.onerror = xhr.ontimeout = function() {
                    t("")
                }
                xhr.onreadystatechange = (t) => {
                    if (4 === xhr.readyState) {
                        if (200 === xhr.status) {
                            t("")
                        } else {
                ...
                urlParams.append(json, JSON.stringify(e))
    ...
    try {
        ...
        I.br = J.brand || "", I.md = J.model || "", I.pr = J.pixelRatio || "", I.sw = J.screenWidth || "", I.sh = J.screenHeight || "", I.ww = J.windowWidth || "", I.wh = J.windowHeight || "", I.lang = J.language || "", I.wv = J.COREVersion || "", I.sv = J.system || "", I.wvv = J.platformVersionName || "", I.wsdk = J.platformVersionCode || "", I.bh = J.benchmarkLevel || "", I.bt = J.battery || "", I.wf = J.wifiSignal || "", I.lng = "", I.lat = "", I.nt = "", I.spd = "", I.ufo = ""
    } catch (e) { }
	...
	wx.igsEvent = {}
	wx.igsEvent.report = function (msg) {
