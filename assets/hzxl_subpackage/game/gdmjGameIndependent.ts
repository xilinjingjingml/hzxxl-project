...
export default class gdmjGameIndependent extends AbstractGameIndependent{

    initGame(initparams: any, cb: GameIndependentCallback): void {
        cc.assetManager.loadBundle("gdmj", (err, bundle)=>{
            console.log("gdmjGameIndependent initGame err", err)
            cb(this, {})
        })        
    }
    ...
    getFanRatioConfig(fan: number): number{
        ...
        switch (fan) {
            ...
            case Fan.YiSeShuangLongHui:
                return 2
            case  Fan.LianQiDui, Fan.ShuangLongQiDui:
                return 2
            case  Fan.DanLongQiDui:
                return 2
            case Fan.QiDui:
    ...
    getPrivateRoomShowRuleLabels(): string[] {
        return ["max_player_num","base_room_time", "auto_play_game", "max_fan","maima_num", "maima_type", "kaima_type", "guipai_type","qiangganghu",
        "bixuzimo", "liujusuangang", "qianggangchengbao", "gangbaochengbao", "luodichengbao", "genzhuang", "budaifeng","jiejiegao","wuguijiabei","magengang","lastpeng"]
    }
}
GameIndependent.register("09965902-5d1e-4632-ac38-8d4551dc1143", gdmjGameIndependent)