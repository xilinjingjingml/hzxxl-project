...
$root.push = (function() {
    ...
    push.MsgPushNot = (function() {
         ...
         * @property {string|null} [sender] MsgPushNot sender
         */
    ...
    push.PushMessageReq = (function() {

        /**
         * Properties of a PushMessageReq.
         * @memberof push
         * @interface IPushMessageReq
         * @property {string|null} [openid] PushMessageReq openid
         * @property {string|null} [message] PushMessageReq message
         * @property {number|null} [showType] PushMessageReq showType
         */

        /**
         * Constructs a new PushMessageReq.
         * @memberof push
         * @classdesc Represents a PushMessageReq.
         * @implements IPushMessageReq
         * @constructor
         * @param {push.IPushMessageReq=} [properties] Properties to set
         */
        function PushMessageReq(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {string} openid
         * @memberof push.PushMessageReq
         * @instance
         */
        PushMessageReq.prototype.openid = "";
         ...
         * @instance
         */
        PushMessageReq.prototype.message = "";
         ...
         * @instance
         */
        PushMessageReq.prototype.showType = 0;
         ...
         * @static
         * @param {push.IPushMessageReq=} [properties] Properties to set
         * @returns {push.PushMessageReq} PushMessageReq instance
         */
        PushMessageReq.create = function create(properties) {
            return new PushMessageReq(properties);
        };
         ...
         * @memberof push.PushMessageReq
         * @static
         * @param {push.IPushMessageReq} message PushMessageReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        PushMessageReq.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.openid != null && message.hasOwnProperty("openid"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.openid);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        PushMessageReq.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {push.PushMessageReq} PushMessageReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PushMessageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.push.PushMessageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PushMessageReq.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        PushMessageReq.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.openid != null && message.hasOwnProperty("openid"))
                if (!$util.isString(message.openid))
         ...
         * @returns {push.PushMessageReq} PushMessageReq
         */
        PushMessageReq.fromObject = function fromObject(object) {
            if (object instanceof $root.push.PushMessageReq)
                return object;
            var message = new $root.push.PushMessageReq();
            if (object.openid != null)
                message.openid = String(object.openid);
         ...
         * @memberof push.PushMessageReq
         * @static
         * @param {push.PushMessageReq} message PushMessageReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        PushMessageReq.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        PushMessageReq.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    push.PushMessageRsp = (function() {

        /**
         * Properties of a PushMessageRsp.
         * @memberof push
         * @interface IPushMessageRsp
         * @property {string|null} [err] PushMessageRsp err
         */

        /**
         * Constructs a new PushMessageRsp.
         * @memberof push
         * @classdesc Represents a PushMessageRsp.
         * @implements IPushMessageRsp
         * @constructor
         * @param {push.IPushMessageRsp=} [properties] Properties to set
         */
        function PushMessageRsp(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * PushMessageRsp err.
         * @member {string} err
         * @memberof push.PushMessageRsp
         * @instance
         */
        PushMessageRsp.prototype.err = "";
         ...
         * @static
         * @param {push.IPushMessageRsp=} [properties] Properties to set
         * @returns {push.PushMessageRsp} PushMessageRsp instance
         */
        PushMessageRsp.create = function create(properties) {
            return new PushMessageRsp(properties);
        };
         ...
         * @memberof push.PushMessageRsp
         * @static
         * @param {push.IPushMessageRsp} message PushMessageRsp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        PushMessageRsp.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
         ...
         * @returns {$protobuf.Writer} Writer
         */
        PushMessageRsp.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {push.PushMessageRsp} PushMessageRsp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PushMessageRsp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.push.PushMessageRsp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PushMessageRsp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        PushMessageRsp.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.err != null && message.hasOwnProperty("err"))
         ...
         * @returns {push.PushMessageRsp} PushMessageRsp
         */
        PushMessageRsp.fromObject = function fromObject(object) {
            if (object instanceof $root.push.PushMessageRsp)
                return object;
            var message = new $root.push.PushMessageRsp();
            if (object.err != null)
         ...
         * @memberof push.PushMessageRsp
         * @static
         * @param {push.PushMessageRsp} message PushMessageRsp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        PushMessageRsp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
         ...
         * @returns {Object.<string,*>} JSON object
         */
        PushMessageRsp.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return PushMessageRsp;
    })();
    ...
    push.MatchingStatusNot = (function() {

        /**
         * Properties of a MatchingStatusNot.
         * @memberof push
         * @interface IMatchingStatusNot
         * @property {string|null} [err] MatchingStatusNot err
         * @property {string|null} [matchCid] MatchingStatusNot matchCid
         * @property {string|null} [matchId] MatchingStatusNot matchId
         * @property {number|Long|null} [startTime] MatchingStatusNot startTime
         */

        /**
         * Constructs a new MatchingStatusNot.
         * @memberof push
         * @classdesc Represents a MatchingStatusNot.
         * @implements IMatchingStatusNot
         * @constructor
         * @param {push.IMatchingStatusNot=} [properties] Properties to set
         */
        function MatchingStatusNot(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {string} err
         * @memberof push.MatchingStatusNot
         * @instance
         */
        MatchingStatusNot.prototype.err = "";
         ...
         * @instance
         */
        MatchingStatusNot.prototype.matchCid = "";
         ...
         * @instance
         */
        MatchingStatusNot.prototype.matchId = "";
         ...
         * @instance
         */
        MatchingStatusNot.prototype.startTime = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @static
         * @param {push.IMatchingStatusNot=} [properties] Properties to set
         * @returns {push.MatchingStatusNot} MatchingStatusNot instance
         */
        MatchingStatusNot.create = function create(properties) {
            return new MatchingStatusNot(properties);
        };
         ...
         * @memberof push.MatchingStatusNot
         * @static
         * @param {push.IMatchingStatusNot} message MatchingStatusNot message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MatchingStatusNot.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.err != null && message.hasOwnProperty("err"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.err);
            if (message.matchCid != null && message.hasOwnProperty("matchCid"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.matchCid);
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MatchingStatusNot.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {push.MatchingStatusNot} MatchingStatusNot
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MatchingStatusNot.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.push.MatchingStatusNot();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MatchingStatusNot.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MatchingStatusNot.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.err != null && message.hasOwnProperty("err"))
                if (!$util.isString(message.err))
         ...
         * @returns {push.MatchingStatusNot} MatchingStatusNot
         */
        MatchingStatusNot.fromObject = function fromObject(object) {
            if (object instanceof $root.push.MatchingStatusNot)
                return object;
            var message = new $root.push.MatchingStatusNot();
            if (object.err != null)
                message.err = String(object.err);
         ...
         * @memberof push.MatchingStatusNot
         * @static
         * @param {push.MatchingStatusNot} message MatchingStatusNot
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MatchingStatusNot.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MatchingStatusNot.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return MatchingStatusNot;
    })();
