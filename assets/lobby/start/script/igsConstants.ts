 ...
 * @LastEditTime: 2022-03-22 11:28:07
 */

export namespace Constants {

    export let version: string = "v0.3.0.58"
    export let versionCode: number = 1
    export let auditCode: number = 39     //审核版本控制
    ...
    export let DATA_DEFINE = cc.Enum({
        ...
        GAMEING_MATCH_INFO: 1026,

        USER_SEX: 1027,
        
        CHECK_REAL_TIME_MACTH: 1028,

        SHOW_ACTIVITY_COUNT: 1029,

        HIDE_BROKE_POP: 1030,

        VIP_PRIVILEGE_LEVEL: 1031,
    ...
    export enum EVENT_DEFINE {
        ...
        REFRESH_ACTIVITY_ROOLED_CONINS = "refresh_activity_rolled_coins",
        ...
        UPDATE_USER_SEX = "update_user_sex",

        UPDATE_VIP_PRIVILEGE = "update_vip_privilege",
        UPDATE_VIP_CARD = "update_vip_card",

        PLUGIN_ON_SHOW = "plugin_on_show"
    }
    ...
    export enum ITEM_INDEX {
        ...
        ROTARY_TABLE_COIN = 7,//转盘币
        GAME_DIAMOND = 8, // 麻将钻石

        MemberCard = 301, // 会员系统/白银周卡
        SupreMemberCard = 10020, // 会员系统/至尊周卡
        
        QpVipLevel = 303, // 棋牌vip等级
        QpVipExp = 304,   // 棋牌vip经验值
        ...
        GAME_GOLD = 10005, // 麻将金币
        GAME_BEAN = 10006, // 麻将金豆

        DDZ_GOLD = 10009, // 斗地主金币

        MJ_DOUBLE_CARD = 10014, // 麻将双倍卡
        MJ_CAPPED_CARD = 10015, // 麻将封顶卡
        MJ_HONGZHONG_CARD = 10016, // 红中开局卡

        SuperDoubleCard = 10017,  //  超级加倍卡
        RecorderCard = 10018,     //  记牌器
    ...
    export enum GAME_TYPE_LABLE {
        MAJIONG_HZXL = "hzxl:1",        //红中血流
        MAJIONG_6HZXL = "hzxl:2",        //6红中血流
        MAJIONG_8HZXL = "hzxl:3",        //8红中血流
        MAJIONG_XLCH = "hzxl:4",        //血流成河
        MAJIONG_XZHSZ = "hzxl:5",        //血战换三张

        DDZ_SANREN = "ddz:1",        //叫三分
        DDZ_QDZ = "ddz:2",        //抢地主
        DDZ_BXP = "ddz:3",        //不洗牌模式
        DDZ_ERDDZ = "ddz:4",        //二人斗地主
