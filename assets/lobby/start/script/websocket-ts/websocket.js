...
var Websocket = /** @class */ (function () {
    ...
    function Websocket(url, protocols, buffer, backoff, pem) {
        console.log("Websocket1111111111")
        var _this = this;
    ...
    Websocket.prototype.send = function (data) {
        ...
        //     console.log("Websocket send closedByUser is true")
        //     return;
        // }
    ...
    Websocket.prototype.close = function (code, reason) {
        console.log("=== Websocket.prototype.close===")        
        var _a;
    ...
    Websocket.prototype.tryConnect = function () {
        console.log("===Websocket try connect===")
        ...
        if (this.websocket !== undefined) { // remove all event-listeners from broken socket
            ...
            console.log("=== Websocket this.websocket.close===")            
        }
        console.log(this.websocket)
    ...
    Websocket.prototype.handleEvent = function (type, ev) {
        ...
        switch (type) {
            case WebsocketEvents.close:
                console.log("Websocket handleEvent")
                if(ev){
                    console.log("Websocket handleEvent code", ev.code)
                    console.log("Websocket handleEvent reason", ev.reason)
                }
                if (ev?.code == 1000 && ev?.reason == "interrupted") {
                // if (code == 1000 && reason == "interrupted") {
                    this.closedByUser = true
                }
                console.log("Websocket handleEvent this.closedByUser", this.closedByUser)
    ...
    Websocket.prototype.reconnect = function () {
        ...
        this.retryFunc = setTimeout(function () {
    ...
    Websocket.prototype.checkReady = function(){
        console.log("Websocket check net ready")
