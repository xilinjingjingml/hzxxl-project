...
export namespace InvitationSrv{
    // 获取个人信息
    const GET_PROMOTE_INFO = "promote-system-srv/Invitation/GetPromoteInfo"
    // 绑定推广
    const BIND_PROMOTE = "promote-system-srv/Invitation/BindPromote"
