...
declare type IBlockUIOpt = (blockuiNode: cc.Node) => void;
export declare namespace igs { }
export declare namespace igs {
    let log: typeof $log;
    let blockUI: (opt?: IBlockUIOpt) => void;
    let unBlockUI: (opt?: IBlockUIOpt) => void;
}
export declare namespace igs {
...
export declare namespace igs.consts {
    enum Event {
        ...
        IGS_SAFEAREA_CHANGED = "igs-safearea-changed"
    }
    enum ENV {
        ENV_PRODUCTION = 0,
        ENV_SANDBOX = 1,
...
declare enum TrackName {
    ...
    IGS_GET_ONLINE_PARAM_RETRY = "\u52A0\u8F7D-2.2.3\u91CD\u8BD5\u83B7\u53D6\u5728\u7EBF\u53C2\u6570",
    ...
    IGS_SHARE_ACTIVITY = "\u79C1\u5BC6\u5206\u4EAB",
    IGS_SHARE_CAPTURE_SCREEN = "\u622A\u5C4F\u5206\u4EAB",
    IGS_SHARE_CAPTURE_NODE = "\u8282\u70B9\u5206\u4EAB",
    IGS_SHARE_COMMON = "\u666E\u901A\u5206\u4EAB"
}
export declare namespace igs.util {
    ...
    function printStack(): string;
    function compareVersion(vl: string, vr: string): 1 | -1 | 0;
    function getFixString(str: any, len: any): any;
}
declare class BaseObject extends cc.Object {
    TAG: string;
    private _timer;
    private _id;
    delayCallback(callback: Function, target: any, delay: number): number;
    cancelDelayCallback(target: any): void;
    destroy(): any;
    addEventListener: (name: string, callback: Function, target?: any) => void;
    hasEventListener: (name: string, callback: Function, target?: any) => void;
    dispatchEvent: (name: string, arg1?: any, arg2?: any, arg3?: any, arg4?: any, arg5?: any) => void;
    removeEventListener: (name: string, callback: Function, target?: any) => void;
}
declare class assetManager extends BaseObject {
    private static inst;
    private assetCache;
    static instance(): assetManager;
    releaseNode(inst: cc.Node): void;
}
export declare namespace igs {
...
export declare namespace igs {
    ...
    class ModelBase extends BaseObject {
        static TAG: string;
        observers: Map<number, IObserverItem[]>;
        init(): void;
        addObserver(id: number | number[], callback: Function, target: any): void;
        removeObserver(target: any, id: number): void;
        notifyAllObserversByName(id: number, t: any, n: any): void;
        destroy(): any;
    }
    class ModelManager extends BaseObject {
        static TAG: string;
        static _instance: ModelManager;
        models: Map<any, any>;
        static get instance(): ModelManager;
        hasRegisterModel<T extends ModelBase>(m: T): boolean;
        registerModel<T extends ModelBase>(m: {
            new (): T;
        }, arg?: any): void;
        getModel<T extends ModelBase>(m: {
            new (): T;
        }): T;
        destroyModel<T extends ModelBase>(m: T): void;
    }
}
...
export declare namespace igs.platform {
    ...
    interface IShareCaptureParam {
        captureNode?: cc.Node;
        dw?: number;
        dh?: number;
    }
    interface IShareActivityParam {
        activityId: string;
        ext: Record<string, string>;
    }
    interface IShareObjParam {
        shareContent: string;
        sharePicUrl: string;
    }
    interface IShareRoomShareParam {
        bgInfo: {
            url: string;
            width?: number;
            height?: number;
    ...
    interface IShareParam {
        ...
        query?: any;
        queryExt?: any;
        param?: IShareCaptureParam | IShareActivityParam | IShareRoomShareParam;
        shareObj?: IShareObjParam | any;
    }
}
...
export declare namespace igs.odc {
    let init: (node: cc.Node) => void;
    let showListData: (key?: string, value?: {
        wxopenid?: string;
    } | any) => void;
    let clearList: () => void;
    ...
    let updateScore2: (key: string, value?: {
        save?: any;
        wxopenid: string;
        score: number;
    }) => void;
    let setMessageToFriendQuery: (value: number) => void;
}
...
export declare namespace igs.i18n {
    function setLan(lan: string): void;
    function getLan(): string;
}
export declare namespace igs.platform {
    function trackEvent(name: string, detail?: igs.platform.TrackEventDetail, labels?: string[]): void;
    function setScreenCapInfo(info: igs.platform.ScreenCapInfo): igs.platform.ScreenCapResult;
    function trackUserAction(name: string): void;
    function share(param: IShareParam): void;
    function onShareAppMessage(fn: () => IShareParam): void;
    function launchParam(key?: string): any;
}
